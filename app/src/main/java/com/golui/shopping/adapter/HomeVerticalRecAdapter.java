...
public class HomeVerticalRecAdapter extends RecyclerView.Adapter<HomeVerticalRecAdapter.ViewHolder> {
    private RecyclerView parentRecycler;
    private ItemClickedListener itemClickedListener;
    private List<ProductListItems> productListItemses;

    public HomeVerticalRecAdapter(Context context, List<ProductListItems> productListItemses, ItemClickedListener itemClickedListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = inflater.inflate(R.layout.adapter_home_vertical_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        ViewCompat.setTransitionName(holder.IV_banner, "Vertical_position_" + position);
    }
